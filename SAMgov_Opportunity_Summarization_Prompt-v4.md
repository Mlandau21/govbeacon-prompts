...
### **Example 1 – Solicitation (Improved)**
...
The effort covers inspection, service, and emergency maintenance for all base elevators, escalators, and lifts. Evaluation will follow a *Lowest Price Technically Acceptable* process emphasizing experience and safety performance.  
...
### **Example 3 – Small Business Solicitation (Improved)**
...
Work includes maintenance, repair, and troubleshooting of heavy engineering equipment and cranes under a *Time & Materials RFQ* estimated at **$80,000/year**. Proposals will be evaluated for technical capability and local staffing qualifications.  
...
*(Examples unchanged from previous version for reference.)*
